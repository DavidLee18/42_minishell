...
BONUS_SRCS := src/bonus/builtin_bonus.c src/bonus/builtin2_bonus.c src/bonus/builtin3_bonus.c src/bonus/env_bonus.c src/bonus/etc_bonus.c src/bonus/etc2_bonus.c \
	src/bonus/etc3_bonus.c src/bonus/etc4_bonus.c src/bonus/etc5_bonus.c \
	src/bonus/interact_bonus.c src/bonus/interact2_bonus.c src/bonus/interact3_bonus.c src/bonus/lex_bonus.c \
	...
	src/bonus/parse4_bonus.c src/bonus/process_bonus.c src/bonus/process2_bonus.c \
